...
export const TRANSLATIONS = {
  ar: {
    ...
    men: 'رجال', menDesc: 'أرقى الحلاقين المحترفين', or: 'أو',
  ...
  en: {
    ...
    men: 'Men', menDesc: 'World-class professional barbers', or: 'OR',
  ...
  tr: {
    ...
    men: 'Erkek', menDesc: 'Profesyonel dünya çapında berberler', or: 'VEYA',
